...
const Sidebar = () => {
   ...
   const tokencr = Cookies.get('token')
    return (  
        ...
        <Image src={logo} alt=".." width={70} height={70} style={{boxShadow: "inset 2px 2px 5px #babecc,inset -5px -5px 10px #ffffff73", width:"6em" , height:"6em" , borderRadius:"50%" , padding:"0.5em 0.5em"}} />     
