  ...
  return (
    <>
      <Stack flexDirection="column" justifyContent="center" alignItems="center" sx={{ background:"#dde1e7", height: "100vh" }}>
       ...
       <Box className="pad" component='img' src='/404.svg' sx={{width:"450px" ,  mixBlendMode:"multiply" , height:"auto",  filter: "drop-shadow(2px 2px 5px #babecc,-5px -5px 10px #ffffff73)"}}/>
         <Box sx={{marginTop:"2em" , display:"flex" , flexDirection:"column" , gap:"1.1em" , justifyContent:"center" , alignItems:"center"}}> 
